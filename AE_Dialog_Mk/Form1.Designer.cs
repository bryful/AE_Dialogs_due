namespace AE_Dialog_Mk
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			a_statictext41 = new A_statictext();
	...
	32
			...
			a_statictext1.AE_objName = "stCopies";
			a_statictext1.AE_scrolling = false;
			a_statictext1.AE_text = "Copies";
			a_statictext1.DataContext = null;
			a_statictext1.Font = new Font("Tahoma", 8.25F);
			a_statictext1.Image = null;
			a_statictext1.Location = new Point(12, 12);
			a_statictext1.Name = "a_statictext1";
			a_statictext1.Size = new Size(55, 20);
			a_statictext1.TabIndex = 0;
			a_statictext1.Text = "Copies";
			// 
			// a_edittext1
			// 
	...
	"15"
			...
			a_edittext1.Location = new Point(73, 12);
			a_edittext1.Name = "a_edittext1";
			a_edittext1.Size = new Size(60, 20);
			a_edittext1.TabIndex = 1;
			a_edittext1.Text = "15";
			// 
			// a_edittext2
			// 
	...
	32
			...
			a_edittext2.AE_objName = "edOffset";
			a_edittext2.AE_readonly = false;
			a_edittext2.AE_scrollable = false;
			a_edittext2.AE_text = "-7";
			a_edittext2.AE_textLines = new string[]
	{
	"-7"
	};
			a_edittext2.DataContext = null;
			a_edittext2.Font = new Font("Tahoma", 8.25F);
			a_edittext2.Location = new Point(207, 12);
			a_edittext2.Name = "a_edittext2";
			a_edittext2.Size = new Size(60, 20);
			a_edittext2.TabIndex = 3;
			a_edittext2.Text = "-7";
			// 
			// a_statictext2
			// 
	...
	32
			...
			a_statictext2.AE_objName = "stOffset";
			a_statictext2.AE_scrolling = false;
			a_statictext2.AE_text = "Offset";
			a_statictext2.DataContext = null;
			a_statictext2.Font = new Font("Tahoma", 8.25F);
			a_statictext2.Image = null;
			a_statictext2.Location = new Point(146, 12);
			a_statictext2.Name = "a_statictext2";
			a_statictext2.Size = new Size(55, 20);
			a_statictext2.TabIndex = 2;
			a_statictext2.Text = "Offset";
			// 
			// a_edittext3
			// 
	...
	58
			...
			a_edittext3.AE_objName = "edY";
			a_edittext3.AE_readonly = false;
			a_edittext3.AE_scrollable = false;
			a_edittext3.AE_text = "0";
			a_edittext3.AE_textLines = new string[]
	{
	"0"
	};
			a_edittext3.DataContext = null;
			a_edittext3.Font = new Font("Tahoma", 8.25F);
			a_edittext3.Location = new Point(207, 38);
			a_edittext3.Name = "a_edittext3";
			a_edittext3.Size = new Size(60, 20);
			a_edittext3.TabIndex = 7;
			a_edittext3.Text = "0";
			// 
			// a_statictext3
			// 
	...
	58
			...
			a_statictext3.AE_objName = "stY";
			a_statictext3.AE_scrolling = false;
			a_statictext3.AE_text = "Y";
			a_statictext3.DataContext = null;
			a_statictext3.Font = new Font("Tahoma", 8.25F);
			a_statictext3.Image = null;
			a_statictext3.Location = new Point(146, 38);
			a_statictext3.Name = "a_statictext3";
			a_statictext3.Size = new Size(55, 20);
			a_statictext3.TabIndex = 6;
			a_statictext3.Text = "Y";
			// 
			// a_edittext4
			// 
	...
	58
			...
			a_edittext4.AE_objName = "edX";
			a_edittext4.AE_readonly = false;
			a_edittext4.AE_scrollable = false;
			a_edittext4.AE_text = "10";
			a_edittext4.AE_textLines = new string[]
	{
	"10"
	};
			a_edittext4.DataContext = null;
			a_edittext4.Font = new Font("Tahoma", 8.25F);
			a_edittext4.Location = new Point(73, 38);
			a_edittext4.Name = "a_edittext4";
			a_edittext4.Size = new Size(60, 20);
			a_edittext4.TabIndex = 5;
			a_edittext4.Text = "10";
			// 
			// a_statictext41
			// 
			a_statictext41.AE_bounds = new int[]
	{
	12,
	38,
	67,
	58
			...
			a_statictext41.AE_multiline = false;
			a_statictext41.AE_objName = "stX";
			a_statictext41.AE_scrolling = false;
			a_statictext41.AE_text = "X";
			a_statictext41.DataContext = null;
			a_statictext41.Font = new Font("Tahoma", 8.25F);
			a_statictext41.Image = null;
			a_statictext41.Location = new Point(12, 38);
			a_statictext41.Name = "a_statictext41";
			a_statictext41.Size = new Size(55, 20);
			a_statictext41.TabIndex = 4;
			a_statictext41.Text = "X";
			// 
			// a_statictext5
			// 
	...
	89
			...
			a_statictext5.AE_objName = "stUnit";
			a_statictext5.AE_scrolling = false;
			a_statictext5.AE_text = "単位";
			a_statictext5.DataContext = null;
			a_statictext5.Font = new Font("Tahoma", 8.25F);
			a_statictext5.Image = null;
			a_statictext5.Location = new Point(12, 69);
			a_statictext5.Name = "a_statictext5";
			a_statictext5.Size = new Size(55, 20);
			a_statictext5.TabIndex = 8;
			a_statictext5.Text = "単位";
			// 
			// a_radiobutton1
			// 
	...
	89
			...
			a_radiobutton1.AE_value = true;
			a_radiobutton1.Checked = true;
			a_radiobutton1.DataContext = null;
			a_radiobutton1.Font = new Font("Tahoma", 8.25F);
			a_radiobutton1.Image = null;
			a_radiobutton1.Location = new Point(77, 69);
			a_radiobutton1.Name = "a_radiobutton1";
			a_radiobutton1.Size = new Size(50, 20);
			a_radiobutton1.TabIndex = 9;
			a_radiobutton1.TabStop = true;
	...
	89
			...
			a_radiobutton2.Location = new Point(130, 69);
			a_radiobutton2.Name = "a_radiobutton2";
			a_radiobutton2.Size = new Size(50, 20);
			a_radiobutton2.TabIndex = 10;
	...
	89
			...
			a_radiobutton3.Location = new Point(186, 69);
			a_radiobutton3.Name = "a_radiobutton3";
			a_radiobutton3.Size = new Size(50, 20);
			a_radiobutton3.TabIndex = 11;
	...
	89
			...
			a_edittext5.AE_objName = "edDpi";
			a_edittext5.AE_readonly = false;
			a_edittext5.AE_scrollable = false;
			a_edittext5.AE_text = "300";
			a_edittext5.AE_textLines = new string[]
	{
	"300"
	};
			a_edittext5.DataContext = null;
			a_edittext5.Font = new Font("Tahoma", 8.25F);
			a_edittext5.Location = new Point(241, 69);
			a_edittext5.Name = "a_edittext5";
			a_edittext5.Size = new Size(60, 20);
			a_edittext5.TabIndex = 12;
			a_edittext5.Text = "300";
			// 
			// a_button1
			// 
	...
	134
			...
			a_button1.AE_objName = "btnApply";
			a_button1.AE_text = "Apply";
	...
	134
			...
			a_button3.AE_objName = "btnClose";
			a_button3.AE_text = "Close";
			a_button3.DataContext = null;
			a_button3.Font = new Font("Tahoma", 8.25F);
			a_button3.Image = null;
			a_button3.Location = new Point(227, 98);
			a_button3.Name = "a_button3";
			a_button3.Size = new Size(74, 36);
			a_button3.TabIndex = 15;
	...
	202
			...
			Controls.Add(a_edittext5);
			Controls.Add(a_radiobutton3);
			Controls.Add(a_radiobutton2);
			Controls.Add(a_radiobutton1);
			Controls.Add(a_statictext5);
			Controls.Add(a_edittext3);
			Controls.Add(a_statictext3);
			Controls.Add(a_edittext4);
			Controls.Add(a_statictext41);
			Controls.Add(a_edittext2);
			Controls.Add(a_statictext2);
			Controls.Add(a_edittext1);
			Controls.Add(a_statictext1);
			DoubleBuffered = true;
			Name = "Form1";
			Text = "アートボードで回転";
			ResumeLayout(false);
		...
		private A_statictext a_statictext41;
