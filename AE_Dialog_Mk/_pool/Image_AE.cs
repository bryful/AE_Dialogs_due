...
namespace BRY
{
	public class Image_AE : PictureBox
	{
		...
		public string ScriptCode
		{
			get
			{
				...
				ret += $".add(\"button\", {BoundStr}, \"{AE_text}\")";
				return ret;
			}
		}
		//------------------------------------------------------------------------------------------------------------
		...
		[Browsable(false)]
		public new System.Drawing.Image ErrorImage
		{
		...
		[Browsable(false)]
		public new System.String ImageLocation
		{
			get { return base.ImageLocation; }
			set { base.ImageLocation = value; }
		}
		[Browsable(false)]
		public new System.Drawing.Image InitialImage
		{
		...
		[Browsable(false)]
		public new System.Windows.Forms.PictureBoxSizeMode SizeMode
		{
		...
		[Browsable(false)]
		public new System.Boolean WaitOnLoad
		{
